...
import type { Track, VideoPlayerProps } from "./components/VideoPlayer.types";
...
const VideoPlayer = ({
  ...
  return (
    <div
      className={cn(
        "relative w-full max-h-[85vh] overflow-hidden bg-black rounded-md transition-all duration-300",
